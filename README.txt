...
•	There is a local virtual machine in the deployer's computer with AWX Tower (Ansible Tower) that can pull the YAML configurations and update the local configurations when running in the local Ansible virtual machine.
